...
load([path(1:end-3) 'mat\for_xsep.mat'],'dB_vsf','r2star','Mag_brain','mask_vsf','TE','B0','H','voxsz','voxelsize_new','voxel_size')
...
dire = dir([path(1:end-3) 'mat\inf_from_gpu\inf*']);
load([path(1:end-3) 'mat\inf_from_gpu\' dire(1).name])
load([path(1:end-3) 'mat\inf_from_gpu\' dire(2).name])
