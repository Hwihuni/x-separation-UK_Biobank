...
if __name__ == '__main__':
    ...
    net_u.load_state_dict(torch.load('./checkpoints/DS_Unet_prc_normal_11_22_18_20.pth', map_location=device))
    net_fc.load_state_dict(torch.load('./checkpoints/DS_Fc_prc_normal_11_22_18_20.pth', map_location=device))
